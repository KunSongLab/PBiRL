...
from controls.envs.discrete_env_mo import MonstacEnv
from controls.models.dqn_priority_mo.dqn_priority import PriorityDQN
...
config = {
    ...
    "model": {
        ...
        7: {"input_dims": 15, "hidden_dims": 50, "output_dims": 3},
...
obs = env.reset()
dqn = PriorityDQN(config, device, [10,11, 6,7, 32,33, 14,15, 2,3, 40,41, 36,37, 22,23, 24,25, 28,29, 0,1])

res = dqn.train(env)
dqn.save_results(res, os.path.join(dqn.savepath, "stat.csv"))
